                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
							...
							<hr>
                                <div class="span3">
										<center>
										<img id="developers" src="admin/images/rahul.jpg" class="img-circle">
										<hr>
										<p>Name: Rahul Rajput</p>
										<p>Address: Aligarh</p>
										<p>Email:rahul.rajput_cs20@gla.ac.in</p>
										<p>Position: Programmer</p>
										</center>
								</div>
                                <!-- <div class="span3">
															<center>
								<img id="developers" src="admin/images/jely.jpg" class="img-circle">
								<hr>
																				<p>Name: Praveen</p>
